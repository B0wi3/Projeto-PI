                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="https://web.facebook.com/ProjetoIntegrador/">Facebook</a>
                            <a class="dropdown-item" href="https://twitter.com/ProjetoItegrador/">Twitter</a>
                            <a class="dropdown-item" href="https://www.instagram.com/ProjetoIntegrador/">Instagram</a>
                            <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=11900000000">Whatsapp</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="btn btn-outline-primary" my-2 my-sm-0" data-toggle="modal" data-target="#loginModal">Login</button>
...
<a href="#" class="btn btn-warning" center data-toggle="modal" data-target="#requisicaoModal">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cotacao" id="cotacao_sim" value="Sim">
                                <label class="form-check-label" for="cotacao_sim">Sim</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cotacao" id="cotacao_nao" value="Não">
                                <label class="form-check-label" for="cotacao_nao">Não</label>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Contratação:</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="contratacao" id="contratacao_sim" value="Sim">
                                <label class="form-check-label" for="contratacao_sim">Sim</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="contratacao" id="contratacao_nao" value="Não">
                                <label class="form-check-label" for="contratacao_nao">Não</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
